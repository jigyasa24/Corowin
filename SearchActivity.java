            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(com.example.helpus.SearchActivity.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                employees.put(Config5.KEY_TITLE,  "Contact = "+title);
        ...
        ListAdapter adapter = new SimpleAdapter(
                com.example.helpus.SearchActivity.this, list, R.layout.activity_mylist,
